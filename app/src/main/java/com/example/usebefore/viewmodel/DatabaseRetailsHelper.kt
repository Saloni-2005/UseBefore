...
class DatabaseRetailsHelper(private val context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION)  {
    companion object{
        private const val DATABASE_NAME = "UserData"
        private const val DATABASE_VERSION = 1
        private const val TABLE_NAME = "Retailers"
